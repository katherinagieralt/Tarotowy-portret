    ...
    <main className="min-h-screen bg-[#F9F6EE] dark:bg-[#0A0710] py-24 px-6 sm:px-12 transition-colors duration-500">
      <div className="max-w-4xl mx-auto bg-white/70 dark:bg-slate-900/50 backdrop-blur-md rounded-2xl border border-black/5 dark:border-white/5 p-8 sm:p-12 md:p-16 shadow-xl shadow-black/5">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-serif prose-headings:font-bold prose-a:text-amber-600 dark:prose-a:text-amber-400 hover:prose-a:text-amber-500 prose-p:leading-relaxed prose-p:text-slate-600 dark:prose-p:text-slate-300">
          ...
          <p>
            These Terms and Conditions define the general rules, conditions, and methods of providing electronic services through the <strong>Archeya</strong> website (hereinafter: the "Service").
          </p>
          <p>
          ...
          <p>
            The Service allows Clients to generate a paid, personalized psychological profile based on Tarot archetypes. This product is intended strictly for educational, entertainment, and personal development purposes. It does not in any way constitute psychological, medical, or legal advice.
          </p>
          <p>
            To use the Service, a device with Internet access and an up-to-date web browser are required. Receiving the Digital Product additionally requires an active e-mail account and software capable of opening PDF files.
          </p>

          <h2 className="text-2xl mt-10 mb-4">4. Conclusion of the Agreement and Order Execution</h2>
          <p>
            The Agreement is concluded when the Client clicks the button confirming the purchase (e.g., "Buy and pay") and successfully completes the payment via the integrated payment operator (Stripe).
          </p>
          <p>
          ...
          <div className="bg-amber-50 dark:bg-amber-500/10 border-l-4 border-amber-500 p-4 my-8 rounded-r-lg">
            ...
            <p className="text-sm m-0 text-amber-900 dark:text-amber-200">
              Due to the specific nature of the Digital Product (digital content not supplied on a tangible medium), which is prepared and delivered immediately after payment, <strong>the Client, by consenting to the performance of the service before the expiration of the withdrawal period, loses the right to withdraw from a distance contract</strong> (in accordance with Article 38 point 13 of the Polish Consumer Rights Act).
            </p>
          </div>

          <h2 className="text-2xl mt-10 mb-4">6. Payments</h2>
          <p>
            All prices of Products presented in the Service are gross prices (including applicable taxes). Payments are handled by a secure, external payment operator (Stripe). The Seller does not have access to, nor does store, Clients' payment card details.
          </p>

          <h2 className="text-2xl mt-10 mb-4">7. Complaints</h2>
          <p>
            In the event of technical defects in the delivered Digital Product (e.g., the PDF file is corrupted, fails to open, or has not arrived in the inbox despite a cleared payment), the Client has the right to submit a complaint.
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>Complaints should be sent to the e-mail address: <strong>hello@getarcheya.com</strong>.</li>
            <li>In the notification, please provide the e-mail address used during the order and a detailed description of the problem.</li>
            <li>The Seller will process complaints within 14 days of their receipt.</li>
          </ul>

          <h2 className="text-2xl mt-10 mb-4">8. Intellectual Property and Terms of Use</h2>
          <p>
            The structure of the Service, source codes, branding, the unique layout of the Digital Products, and the proprietary content curation rules are legally protected and constitute the exclusive property of the Seller. The Service utilizes artificial intelligence technologies to generate personalized descriptions, and the card images are based on materials available under open licenses or in the public domain.
          </p>
          <p className="mt-4">
            Under this Agreement, the purchased PDF report is intended <strong>strictly for the personal use</strong> of the Client. Regardless of the copyright status of individual components, the Client does not have the right to resell, commercially distribute, modify, or mass-reproduce the generated reports without the prior written consent of the Seller.
          </p>
          ...
          <p>
            The Seller reserves the right to amend the Terms and Conditions for important reasons (e.g., changes in the law or functionality of the Service). Contracts concluded before the amendment to the Terms and Conditions takes effect will be governed by the version in force at the time of purchase.
          </p>
